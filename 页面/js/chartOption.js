...
indexOption = {
    ...
    xAxis: [{
        ...
        margin: 2,
        data: ["16年03月","16年04月","16年05月","16年06月","16年07月","16年08月","16年09月","16年10月"]
    }],
    yAxis: [{
        gridIndex: 0,
        type: 'value',
...
$.each(features, function(i, obj){
    ...
    geoCoordMap2[name] = cp;
});
geoCoordMap2['义乌'] = [120.0816,29.3103];
...
var YWData = [
    [{name:'义乌'}, {name:'上海',value:95}],
    [{name:'义乌'}, {name:'广东',value:90}],
    [{name:'义乌'}, {name:'广西',value:80}],
    [{name:'义乌'}, {name:'山东',value:70}],
    [{name:'义乌'}, {name:'江西',value:60}],
    [{name:'义乌'}, {name:'西藏',value:50}],
    [{name:'义乌'}, {name:'吉林',value:40}],
    [{name:'义乌'}, {name:'山西',value:30}],
    [{name:'义乌'}, {name:'重庆',value:20}],
    [{name:'义乌'}, {name:'江苏',value:10}]
];
...
var series = [];
[['义乌', YWData]].forEach(function (item, i) {
    console.log(item[0]);
    series.push({
        name: item[0],
        type: 'lines',
